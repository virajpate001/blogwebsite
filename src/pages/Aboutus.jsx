          ...
          <div className="px-12 py-14">
            <div className=" flex-col-reverse md:flex-row flex flex-wrap justify-center items-center gap-10">
              <div className="w-full sm:w-5/12">
                ...
                <p className="block mt-5 text-base xl:text-lg text-neutral-6000 dark:text-neutral-400">
                ...
                <p className="block mt-2 text-base xl:text-lg text-neutral-6000 dark:text-neutral-400">
                  We’re impartial and independent, and every day we create
                  distinctive, world-class programmes and content which inform,
                  educate and entertain millions of people in the around the
                  world.
